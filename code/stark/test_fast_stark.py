...
class TestFastStark(unittest.TestCase):

    def test_fast_stark(self):
        field = Field.main()
        expansion_factor = 4
        ...
        for trial in range(0, 20):
            ...
            stark = FastStark(field, expansion_factor, num_colinearity_checks,
                              security_level, state_width, num_cycles)
            ...
            proof = stark.prove(trace, air, boundary, transition_zerofier,
            ...
            assert (verdict == False
                    ), "STARK produced from false witness verifies :("
            print("proof rejected! \\o/")
